export const assetsIndex = {
  ...
  textures: {
    ...
    Grassclump_Map: { name: 'Grassclump_Map', path: './assets/textures/grassclump_map.jpg' },
    Grassclump_Map_1024: { name: 'Grassclump_Map_1024', path: './assets/textures/grassclump_map_1024.png' },
    Grassclump_Normal: { name: 'Grassclump_Normal', path: './assets/textures/grassclump_normal.jpg' },
    Grassclump_Normal_1024: { name: 'Grassclump_Normal_1024', path: './assets/textures/grassclump_normal_1024.jpg' },
    Grassclump_Alpha: { name: 'Grassclump_Alpha', path: './assets/textures/grass_alpha.png' },
